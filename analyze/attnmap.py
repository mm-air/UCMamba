...
def main_vssm(det_model=True, showpath= "show/vssmattnmap"):
    ...
    if not det_model:
        data_pth = '/home/shirley/Desktop/Projects/Dataset/tiny-imagenet-200/val'
        #dataset = get_dataset(root='/media/Disk1/Dataset/ImageNet_ILSVRC2012/val', img_size=img_size, crop=False)
        dataset = get_dataset(root=data_pth, img_size=img_size, crop=False)
        idxs_posxs_posys = [
    ...
    if det_model:
        ...
        model_path = '/home/shirley/Desktop/Projects/Revision/vssm1_tiny_0230s_ckpt_epoch_264.pth'
        vssm.load_state_dict(torch.load(open(model_path, "rb"), map_location="cpu")["model"], strict=False)
